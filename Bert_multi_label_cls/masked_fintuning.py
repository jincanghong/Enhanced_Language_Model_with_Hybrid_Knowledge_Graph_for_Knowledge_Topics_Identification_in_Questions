...
class BERTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        cur_example = InputExample(guid=cur_id, tokens_a=tokens_a, tokens_b=None)
...
def main():
    ...
    parser.add_argument("--output_dir",
                        default='/home/cdk/python_project/bert_multi_tag_cls/model/math_all_pretrain_model/math_6w_save_pretrain_model_0716',
                        type=str,
                        required=False,
